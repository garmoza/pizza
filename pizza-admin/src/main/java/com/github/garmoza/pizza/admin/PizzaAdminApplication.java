package com.github.garmoza.pizza.admin;

import com.github.garmoza.pizza.admin.data.IngredientRepository;
import com.github.garmoza.pizza.admin.data.OrderRepository;
...
public class PizzaAdminApplication {

    public static void main(String[] args) {
        SpringApplication.run(PizzaAdminApplication.class, args);
    }
